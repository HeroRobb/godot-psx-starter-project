class_name ProjectileLauncher3D
extends RayCast3D
...
@export var override_projectile_motion: Projectile3D.MOTION_TYPES = Projectile3D.MOTION_TYPES.LINEAR
...
func fire() -> void:
	...
	var new_projectile: Projectile3D = _projectile_scene.instantiate()
	...
	SignalManager.instance_created.emit(new_projectile)
